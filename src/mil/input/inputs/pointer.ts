...
let IE10_POINTER_TYPE_ENUM: any = {
  2: INPUT_TYPE_TOUCH,
  3: INPUT_TYPE_PEN,
  4: INPUT_TYPE_MOUSE,
...
// let POINTER_WINDOW_EVENTS = 'pointermove pointerup';

// IE10 has prefixed support, and case-sensitive
if (window.MSPointerEvent && !window.PointerEvent) {
  POINTER_ELEMENT_EVENTS = "MSPointerDown";
  // POINTER_WINDOW_EVENTS = 'MSPointerMove MSPointerUp';
...
export default class PointerEventInput extends Input {
   ...
   */
  handler(ev: any) {
    // console.log('pointer evt handler ', ev.pointerType);
    let { store } = this;
    ...
    let storeIndex = util.inArray(store, ev.pointerId, "pointerId");
