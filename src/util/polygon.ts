...
import { indexOf, toLength } from "lodash";
...
class Polygon {
    ...
    parseShape(element: HTMLElement) {
        ...
        switch (element.tagName) {
            ...
            default: {
                // console.log("not support " + element.tagName);
                this.useBoundingBox = true;
                return;
            }
        }
        ...
        for (let i = 0; i < numberCommands; i++) {
            ...
            switch (type) {
                ...
                case "A": {
                    ...
                    // console.log(mergeTransform(transform, invTransform));
    ...
    fromBoundingBox(element: HTMLElement) {
        ...
        const topLeft = jsTool.screenToSvgCoords(svg, boundingBox.left, boundingBox.top) as Point;
        const bottomRight = jsTool.screenToSvgCoords(svg, boundingBox.right, boundingBox.bottom) as Point;
